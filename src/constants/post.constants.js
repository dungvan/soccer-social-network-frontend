export const postConstants = {
    ...
    GETBY_USERNAME_REQUEST: 'POSTS_GETBY_USERNAME_REQUEST',
    GETBY_USERNAME_SUCCESS: 'POSTS_GETBY_USERNAME_SUCCESS',
    GETBY_USERNAME_FAILURE: 'POSTS_GETBY_USERNAME_FAILURE',

    GETBY_HASHTAGS_REQUEST: 'POSTS_GETBY_HASHTAGS_REQUEST',
    GETBY_HASHTAGS_SUCCESS: 'POSTS_GETBY_HASHTAGS_SUCCESS',
    GETBY_HASHTAGS_FAILURE: 'POSTS_GETBY_HASHTAGS_FAILURE',
